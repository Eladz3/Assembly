...
.data
num_elements:   .word 5                       # number of program arguments
...
.data
sort_array_test:   .word 0x00000005 0X00000004 0x00000003 0x00000002 0x00000001
sort_array_length: .word 5
...
.data
print_decimal_test: .word -18237                 # modify with sepcific
                                              # test case
